...
class MyStandardScaler(Rescaling, AutoSklearnPreprocessingAlgorithm):
    def __init__(
    ...
    def get_properties(
        ...
        return {
            "shortname": "MyStandardScaler",
            "name": "My Standard Scaler",
    ...
    def fit(
        ...
        return super(MyStandardScaler, self).fit(X, y)
