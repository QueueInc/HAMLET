...
sudo ./scripts/run_hamlet.sh results/baseline_1000_kb balanced_accuracy max 1000 7200 0.2.8 0 4 1
sudo ./scripts/run_hamlet.sh results/hamlet_250_kb balanced_accuracy max 250 1800 0.2.8 0 4 4
